...
try {
    ...
    $resCount = $conn->query("SELECT COUNT(*) AS cnt FROM firmware WHERE product_id = $product_id AND type = 'wifi'");
    ...
    $conn->close();
    header("Location: /admin/user/firmware/wifi.php?msg=Firmware deleted successfully");
    exit;
