...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // --- 1. Total records ---
    $sqlTotal = "SELECT COUNT(*) as cnt FROM logs_email";
    ...
    // --- 6. Data query ---
    $sqlData = "SELECT id, subject, recipient, status, created_at
                FROM logs_email
                $where
...
<div class="card mb-3 shadow-sm border">
    <div class="card-body py-3 px-4">
        <div class="d-flex align-items-center justify-content-between">
            <h5 class="h4 text-primary m-0 fw-bolder">Email Logs</h5>
        </div>
    </div>
</div>
...
$q1 = $conn->query("SELECT COUNT(*) AS cnt FROM logs_email");
$stats['total'] = $q1->fetch_assoc()['cnt'];

$q2 = $conn->query("SELECT COUNT(*) AS cnt FROM logs_email WHERE DATE(created_at) = CURDATE()");
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card text-center shadow-sm border mb-0">
            <div class="card-body">
                ...
                <p class="mb-0 fs-4">Total Emails</p>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
...
$sqlChart = "
    ...
    ORDER BY DATE(created_at) DESC, subject ASC
";
