        ...
        <tr>
            <td align="center" style="padding:40px 0;">
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" 
                    ...
                    <!-- Header with Logo -->
                    <tr>
                        <td align="center" style="padding:25px;padding-bottom: 0px !important;">
                    ...
                    <tr>
                        <td style="padding:30px; color:#333333; font-size:16px; line-height:1.6;">
                            <h2 style="margin-top:0; color:#1d5d9a; font-size:22px; text-align:center;">Reset Your Password</h2>
